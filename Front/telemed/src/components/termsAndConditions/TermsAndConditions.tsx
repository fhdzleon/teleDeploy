...
const TermsAndConditions = () => {
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg overflow-y-auto max-h-[90vh]">
      <h2 className="flex text-center text-primary justify-items-center mb-10  text-2xl font-bold">
        Es importante que leas los Términos & Condiciones y las Políticas de
        Privacidad antes de crear tu cuenta.
      </h2>
      ...
      <div className="text-sm leading-relaxed">
        <section className="mb-4">
          <h3 className="font-semibold">1. Alcance y Uso del Servicio </h3>
          <p>
            ...
            dispositivo compatible para garantizar el correcto desarrollo de las
            consultas. Este servicio está disponible en el territorio de la
            República Argentina y puede ser utilizado por aquellos usuarios que
            residan en zonas habilitadas.
          </p>
          <p>
            El uso de Telemed está destinado exclusivamente a consultas de baja
            complejidad y no es un sustituto de la atención médica de emergencia
            o consultas presenciales cuando sea necesario.
          </p>
        </section>
        ...
        <section className="mb-4">
          ...
          <p>
            El servicio no está diseñado para atender situaciones de emergencia
            ni condiciones médicas graves que requieran atención inmediata.
            Entre los casos que no serán atendidos a través de la plataforma se
            encuentran:
          </p>
          <ul className="list-disc ml-6">
            ...
            <li>
              Administración de medicamentos controlados (narcóticos, opioides,
              etc.).
            </li>
          </ul>
          <p>
            Si experimentas alguno de estos síntomas, acude inmediatamente a una
            sala de emergencias.
          </p>
        </section>
        ...
        <section className="mb-4">
          ...
          <p>
            ...
            tratamientos o recomendaciones proporcionados por los médicos, ni de
            las consecuencias que puedan derivarse del uso del servicio.
          </p>
          <p>
        ...
        <section className="mb-4">
          ...
          <p>
            Telemed no garantiza que las respuestas de los profesionales médicos
            sean exhaustivas o adecuadas para todos los usuarios. El servicio no
            incluye la emisión de certificados médicos o recetas de medicamentos
            controlados.
          </p>
        </section>
        ...
        <section className="mb-4">
          ...
          <ul className="list-disc ml-6">
            ...
            <li>Problemas gastrointestinales leves como vómitos o diarreas.</li>
        ...
        <section className="mb-4">
          ...
          <p>
            Telemed se reserva el derecho de modificar, suspender o descontinuar
            cualquier parte del servicio en cualquier momento. Las
            modificaciones serán notificadas oportunamente.
          </p>
        </section>
