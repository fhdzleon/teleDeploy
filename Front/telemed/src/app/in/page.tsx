    ...
    <div className="flex flex-col items-center space-y-6 p-8">
      ...
      <div>
        <div className="flex justify-start">
          <div className="relative w-[200px] px-5 py-1 max-w-2xl flex justify-center bg-white text-gray-800 border-t border-gray-400 before:absolute before:top-0 before:left-0 before:h-full before:w-[1px] before:bg-gray-400 before:skew-y-12 after:absolute after:top-0 after:right-0 after:h-full after:w-[1px] after:bg-gray-400 after:-skew-y-12">
